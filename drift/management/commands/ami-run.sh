...
curl https://s3.amazonaws.com/aws-cloudwatch/downloads/latest/awslogs-agent-setup.py -o /var/tmp/awslogs-agent-setup.py
CONFIG_FILE=$DRIFT_APP_ROOT/aws/awslogs/awslogs.conf
...
sudo python /var/tmp/awslogs-agent-setup.py --region eu-west-1 --non-interactive --configfile $CONFIG_FILE
